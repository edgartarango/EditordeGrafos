...
namespace EditordeGrafos
{
    public partial class Editor : Form
    {
        ...
        */
        ...
        private void busqAmp_Click(object sender, EventArgs e)
        {
            busqAmp frm = new busqAmp(graph);
            frm.ShowDialog();
        }

        private void toolStripButton7_Click(object sender, EventArgs e)
        {
            busqProf frm = new busqProf(this.graph);
            frm.ShowDialog();
        }

        private void compConexos_Click(object sender, EventArgs e)
        {
            compConexos frm = new compConexos(this.graph);
            frm.ShowDialog();
        }
        private void btnEuler_Click(object sender, EventArgs e)
        {
            Euler frm = new Euler(this.graph);
            frm.ShowDialog();
        }
        ...
        {
            Dijkstra frm = new Dijkstra(this.graph);
            frm.ShowDialog();
        }

        private void toolStripButton8_Click(object sender, EventArgs e)
        {
            Arboles frm = new Arboles();
            frm.ShowDialog();
        }
        ...
        private void toolStripButton9_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Primero crea o abre un grafo.",
                                "Kruskal", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }

            // instanciar con el argumento requerido ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
            using (var f = new KruskalForm(graph))
                f.ShowDialog(this);
        }
